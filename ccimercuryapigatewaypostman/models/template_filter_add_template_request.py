...
class TemplateFilterAddTemplateRequest(object):

    """Implementation of the '/templateFilter/addTemplateRequest' model.
    ...
    def __init__(self,
                 ...
                 coe_ids=None,
                 coe_desc=None):
        """Constructor for the TemplateFilterAddTemplateRequest class"""
