...
class MrdGetMasterReferenceDataRequest(object):

    """Implementation of the '/mrd/getMasterReferenceDataRequest' model.
    ...
    def __init__(self,
                 user_id=None,
                 page_name=None):
        """Constructor for the MrdGetMasterReferenceDataRequest class"""
