...
class AddlocationController(BaseController):

    """A Controller to access Endpoints in the ccimercuryapigatewaypostman API."""
    def __init__(self, config):
        super(AddlocationController, self).__init__(config)

    def mrd_addlocation(self,
                        accept):
        """Does a POST request to /mrd/addlocation.
    ...
    def mrd_addlocation_1(self,
                          accept):
        """Does a GET request to /mrd/addlocation.
