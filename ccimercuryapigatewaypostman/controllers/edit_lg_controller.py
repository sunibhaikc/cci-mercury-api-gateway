...
class EditLgController(BaseController):

    """A Controller to access Endpoints in the ccimercuryapigatewaypostman API."""
    def __init__(self, config):
        super(EditLgController, self).__init__(config)

    def mrd_edit_lg(self,
                    accept,
                    body):
        """Does a POST request to /mrd/editLg.

        TODO: type endpoint description here.

        Args:
            accept (str): TODO: type description here.
            body (MrdEditLgRequest): TODO: type description here.
    ...
    def mrd_edit_lg_1(self,
                      accept):
        """Does a GET request to /mrd/editLg.
