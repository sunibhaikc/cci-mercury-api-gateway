...
class GetuserbygroupController(BaseController):

    """A Controller to access Endpoints in the ccimercuryapigatewaypostman API."""
    def __init__(self, config):
        super(GetuserbygroupController, self).__init__(config)

    def usergroup_getuserbygroup(self,
                                 accept):
        """Does a POST request to /usergroup/getuserbygroup.
    ...
    def usergroup_getuserbygroup_1(self,
                                   accept):
        """Does a GET request to /usergroup/getuserbygroup.
