...
class AddfunctionGroupController(BaseController):

    """A Controller to access Endpoints in the ccimercuryapigatewaypostman API."""
    def __init__(self, config):
        super(AddfunctionGroupController, self).__init__(config)

    def mrd_addfunction_group(self,
                              accept,
                              body):
        """Does a POST request to /mrd/addfunctionGroup.

        TODO: type endpoint description here.

        Args:
            accept (str): TODO: type description here.
            body (MrdAddfunctionGroupRequest): TODO: type description here.
    ...
    def mrd_addfunction_group_1(self,
                                accept):
        """Does a GET request to /mrd/addfunctionGroup.
