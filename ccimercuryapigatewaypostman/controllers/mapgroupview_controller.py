...
class MapgroupviewController(BaseController):

    """A Controller to access Endpoints in the ccimercuryapigatewaypostman API."""
    def __init__(self, config):
        super(MapgroupviewController, self).__init__(config)

    def groupview_mapgroupview(self,
                               accept):
        """Does a POST request to /groupview/mapgroupview.
    ...
    def groupview_mapgroupview_1(self,
                                 accept):
        """Does a GET request to /groupview/mapgroupview.
