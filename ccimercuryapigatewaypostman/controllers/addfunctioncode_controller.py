...
class AddfunctioncodeController(BaseController):

    """A Controller to access Endpoints in the ccimercuryapigatewaypostman API."""
    def __init__(self, config):
        super(AddfunctioncodeController, self).__init__(config)

    def mrd_addfunctioncode(self,
                            accept,
                            body):
        """Does a POST request to /mrd/addfunctioncode.

        TODO: type endpoint description here.

        Args:
            accept (str): TODO: type description here.
            body (MrdAddfunctioncoderequest): TODO: type description here.
    ...
    def mrd_addfunctioncode_1(self,
                              accept):
        """Does a GET request to /mrd/addfunctioncode.
