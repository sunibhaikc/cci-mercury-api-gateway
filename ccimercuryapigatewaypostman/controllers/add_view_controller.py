...
class AddViewController(BaseController):

    """A Controller to access Endpoints in the ccimercuryapigatewaypostman API."""
    def __init__(self, config):
        super(AddViewController, self).__init__(config)

    def view_add_view(self,
                      accept):
        """Does a POST request to /view/addView.
    ...
    def view_add_view_1(self,
                        accept):
        """Does a GET request to /view/addView.
