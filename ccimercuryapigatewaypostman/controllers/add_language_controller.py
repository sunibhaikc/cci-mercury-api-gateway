...
class AddLanguageController(BaseController):

    """A Controller to access Endpoints in the ccimercuryapigatewaypostman API."""
    def __init__(self, config):
        super(AddLanguageController, self).__init__(config)

    def mrd_add_language(self,
                         accept,
                         body):
        """Does a POST request to /mrd/addLanguage.

        TODO: type endpoint description here.

        Args:
            accept (str): TODO: type description here.
            body (MrdAddLanguageRequest): TODO: type description here.
    ...
    def mrd_add_language_1(self,
                           accept):
        """Does a GET request to /mrd/addLanguage.
