...
class GetdashboardviewController(BaseController):

    """A Controller to access Endpoints in the ccimercuryapigatewaypostman API."""
    def __init__(self, config):
        super(GetdashboardviewController, self).__init__(config)

    def dashboard_getdashboardview(self,
                                   accept,
                                   body):
        """Does a POST request to /dashboard/getdashboardview.

        TODO: type endpoint description here.

        Args:
            accept (str): TODO: type description here.
            body (DashboardGetdashboardviewrequest): TODO: type description
                here.
        ...
        return super().new_api_call_builder.request(
            ...
            .path('/dashboard/getdashboardview')
    ...
    def dashboard_getdashboardview_1(self,
                                     accept):
        """Does a GET request to /dashboard/getdashboardview.
