...
class EditforecastedGroupController(BaseController):

    """A Controller to access Endpoints in the ccimercuryapigatewaypostman API."""
    def __init__(self, config):
        super(EditforecastedGroupController, self).__init__(config)

    def mrd_editforecasted_group(self,
                                 accept,
                                 body):
        """Does a POST request to /mrd/editforecastedGroup.

        TODO: type endpoint description here.

        Args:
            accept (str): TODO: type description here.
            body (MrdEditforecastedGroupRequest): TODO: type description
                here.
    ...
    def mrd_editforecasted_group_1(self,
                                   accept):
        """Does a GET request to /mrd/editforecastedGroup.
