...
class AddSLobController(BaseController):

    """A Controller to access Endpoints in the ccimercuryapigatewaypostman API."""
    def __init__(self, config):
        super(AddSLobController, self).__init__(config)

    def mrd_add_s_lob(self,
                      accept,
                      body):
        """Does a POST request to /mrd/addSLob.

        TODO: type endpoint description here.

        Args:
            accept (str): TODO: type description here.
            body (MrdAddSLobRequest): TODO: type description here.
    ...
    def mrd_add_s_lob_1(self,
                        accept):
        """Does a GET request to /mrd/addSLob.
