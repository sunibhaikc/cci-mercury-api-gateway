...
class EditfunctionGroupController(BaseController):

    """A Controller to access Endpoints in the ccimercuryapigatewaypostman API."""
    def __init__(self, config):
        super(EditfunctionGroupController, self).__init__(config)

    def mrd_editfunction_group(self,
                               accept,
                               body):
        """Does a POST request to /mrd/editfunctionGroup.

        TODO: type endpoint description here.

        Args:
            accept (str): TODO: type description here.
            body (MrdEditfunctionGroupRequest): TODO: type description here.
    ...
    def mrd_editfunction_group_1(self,
                                 accept):
        """Does a GET request to /mrd/editfunctionGroup.
