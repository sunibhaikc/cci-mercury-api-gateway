...
class AddorganizationController(BaseController):

    """A Controller to access Endpoints in the ccimercuryapigatewaypostman API."""
    def __init__(self, config):
        super(AddorganizationController, self).__init__(config)

    def mrd_addorganization(self,
                            accept,
                            body):
        """Does a POST request to /mrd/addorganization.

        TODO: type endpoint description here.

        Args:
            accept (str): TODO: type description here.
            body (MrdAddorganizationrequest): TODO: type description here.
    ...
    def mrd_addorganization_1(self,
                              accept):
        """Does a GET request to /mrd/addorganization.
