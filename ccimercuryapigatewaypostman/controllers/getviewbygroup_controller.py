...
class GetviewbygroupController(BaseController):

    """A Controller to access Endpoints in the ccimercuryapigatewaypostman API."""
    def __init__(self, config):
        super(GetviewbygroupController, self).__init__(config)

    def groupview_getviewbygroup(self,
                                 accept):
        """Does a POST request to /groupview/getviewbygroup.
    ...
    def groupview_getviewbygroup_1(self,
                                   accept):
        """Does a GET request to /groupview/getviewbygroup.
