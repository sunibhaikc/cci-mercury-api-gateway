...
class GetbyIdController(BaseController):

    """A Controller to access Endpoints in the ccimercuryapigatewaypostman API."""
    def __init__(self, config):
        super(GetbyIdController, self).__init__(config)

    def template_filter_getby_id(self,
                                 accept):
        """Does a POST request to /templateFilter/getbyId.
    ...
    def template_filter_getby_id_1(self,
                                   accept):
        """Does a GET request to /templateFilter/getbyId.
