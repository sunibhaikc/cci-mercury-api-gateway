...
class GetusersController(BaseController):

    """A Controller to access Endpoints in the ccimercuryapigatewaypostman API."""
    def __init__(self, config):
        super(GetusersController, self).__init__(config)

    def user_getusers(self,
                      accept,
                      body):
        """Does a POST request to /user/getusers.

        TODO: type endpoint description here.

        Args:
            accept (str): TODO: type description here.
            body (UserGetusersrequest): TODO: type description here.
    ...
    def user_getusers_1(self,
                        accept):
        """Does a GET request to /user/getusers.
