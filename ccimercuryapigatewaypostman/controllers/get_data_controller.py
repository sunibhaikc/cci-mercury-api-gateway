...
class GetDataController(BaseController):

    """A Controller to access Endpoints in the ccimercuryapigatewaypostman API."""
    def __init__(self, config):
        super(GetDataController, self).__init__(config)

    def view_get_data(self,
                      accept):
        """Does a POST request to /view/getData.
    ...
    def view_get_data_1(self,
                        accept):
        """Does a GET request to /view/getData.
