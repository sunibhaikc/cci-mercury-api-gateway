...
class MapdashboardviewController(BaseController):

    """A Controller to access Endpoints in the ccimercuryapigatewaypostman API."""
    def __init__(self, config):
        super(MapdashboardviewController, self).__init__(config)

    def dashboard_mapdashboardview(self,
                                   accept):
        """Does a POST request to /dashboard/mapdashboardview.
        ...
        return super().new_api_call_builder.request(
            ...
            .path('/dashboard/mapdashboardview')
    ...
    def dashboard_mapdashboardview_1(self,
                                     accept):
        """Does a GET request to /dashboard/mapdashboardview.
