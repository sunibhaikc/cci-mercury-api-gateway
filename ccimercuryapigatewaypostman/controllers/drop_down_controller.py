...
class DropDownController(BaseController):
    ...
    def __init__(self, config):
        super(DropDownController, self).__init__(config)

    def template_filter_drop_down(self,
                                  accept,
                                  body):
        """Does a POST request to /templateFilter/dropDown.

        TODO: type endpoint description here.

        Args:
            accept (str): TODO: type description here.
            body (TemplateFilterDropDownRequest): TODO: type description
                here.
    ...
    def template_filter_drop_down_1(self,
                                    accept):
        """Does a GET request to /templateFilter/dropDown.
