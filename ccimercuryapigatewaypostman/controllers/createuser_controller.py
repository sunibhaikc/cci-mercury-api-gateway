...
class CreateuserController(BaseController):
    ...
    def __init__(self, config):
        super(CreateuserController, self).__init__(config)

    def user_createuser(self,
                        accept,
                        body):
        """Does a POST request to /user/createuser.

        TODO: type endpoint description here.

        Args:
            accept (str): TODO: type description here.
            body (UserCreateuserrequest): TODO: type description here.
    ...
    def user_createuser_1(self,
                          accept):
        """Does a GET request to /user/createuser.
