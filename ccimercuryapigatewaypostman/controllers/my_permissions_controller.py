...
class MyPermissionsController(BaseController):
    ...
    def __init__(self, config):
        super(MyPermissionsController, self).__init__(config)

    def user_my_permissions(self,
                            accept):
        """Does a POST request to /user/myPermissions.
    ...
    def user_my_permissions_1(self,
                              accept):
        """Does a GET request to /user/myPermissions.
