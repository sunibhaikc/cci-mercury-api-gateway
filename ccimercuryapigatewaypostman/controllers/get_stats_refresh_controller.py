...
class GetStatsRefreshController(BaseController):

    """A Controller to access Endpoints in the ccimercuryapigatewaypostman API."""
    def __init__(self, config):
        super(GetStatsRefreshController, self).__init__(config)

    def alert_get_stats_refresh(self,
                                accept,
                                body):
        """Does a POST request to /alert/getStatsRefresh.

        TODO: type endpoint description here.

        Args:
            accept (str): TODO: type description here.
            body (AlertGetStatsRefreshRequest): TODO: type description here.
    ...
    def alert_get_stats_refresh_1(self,
                                  accept):
        """Does a GET request to /alert/getStatsRefresh.
