...
class GetMoaController(BaseController):

    """A Controller to access Endpoints in the ccimercuryapigatewaypostman API."""
    def __init__(self, config):
        super(GetMoaController, self).__init__(config)

    def liteview_get_moa(self,
                         accept):
        """Does a POST request to /liteview/getMoa.
    ...
    def liteview_get_moa_1(self,
                           accept):
        """Does a GET request to /liteview/getMoa.
