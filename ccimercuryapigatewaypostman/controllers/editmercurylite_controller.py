...
class EditmercuryliteController(BaseController):

    """A Controller to access Endpoints in the ccimercuryapigatewaypostman API."""
    def __init__(self, config):
        super(EditmercuryliteController, self).__init__(config)

    def mrd_editmercurylite(self,
                            accept,
                            body):
        """Does a POST request to /mrd/editmercurylite.

        TODO: type endpoint description here.

        Args:
            accept (str): TODO: type description here.
            body (MrdEditmercuryliterequest): TODO: type description here.
    ...
    def mrd_editmercurylite_1(self,
                              accept):
        """Does a GET request to /mrd/editmercurylite.
