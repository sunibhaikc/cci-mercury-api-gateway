...
class ToggleChangeController(BaseController):

    """A Controller to access Endpoints in the ccimercuryapigatewaypostman API."""
    def __init__(self, config):
        super(ToggleChangeController, self).__init__(config)

    def view_toggle_change(self,
                           accept,
                           body):
        """Does a POST request to /view/toggleChange.

        TODO: type endpoint description here.

        Args:
            accept (str): TODO: type description here.
            body (ViewToggleChangeRequest): TODO: type description here.
    ...
    def view_toggle_change_1(self,
                             accept):
        """Does a GET request to /view/toggleChange.
