...
class ShareviewlogsController(BaseController):

    """A Controller to access Endpoints in the ccimercuryapigatewaypostman API."""
    def __init__(self, config):
        super(ShareviewlogsController, self).__init__(config)

    def view_shareviewlogs(self,
                           accept,
                           body):
        """Does a POST request to /view/shareviewlogs.

        TODO: type endpoint description here.

        Args:
            accept (str): TODO: type description here.
            body (ViewShareviewlogsrequest): TODO: type description here.
    ...
    def view_shareviewlogs_1(self,
                             accept):
        """Does a GET request to /view/shareviewlogs.
