...
class GetResitechController(BaseController):

    """A Controller to access Endpoints in the ccimercuryapigatewaypostman API."""
    def __init__(self, config):
        super(GetResitechController, self).__init__(config)

    def liteview_get_resitech(self,
                              accept):
        """Does a POST request to /liteview/getResitech.
    ...
    def liteview_get_resitech_1(self,
                                accept):
        """Does a GET request to /liteview/getResitech.
