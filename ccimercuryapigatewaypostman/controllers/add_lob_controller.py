...
class AddLobController(BaseController):

    """A Controller to access Endpoints in the ccimercuryapigatewaypostman API."""
    def __init__(self, config):
        super(AddLobController, self).__init__(config)

    def mrd_add_lob(self,
                    accept,
                    body):
        """Does a POST request to /mrd/addLob.

        TODO: type endpoint description here.

        Args:
            accept (str): TODO: type description here.
            body (MrdAddLobRequest): TODO: type description here.
    ...
    def mrd_add_lob_1(self,
                      accept):
        """Does a GET request to /mrd/addLob.
