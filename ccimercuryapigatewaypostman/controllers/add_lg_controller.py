...
class AddLgController(BaseController):

    """A Controller to access Endpoints in the ccimercuryapigatewaypostman API."""
    def __init__(self, config):
        super(AddLgController, self).__init__(config)

    def mrd_add_lg(self,
                   accept,
                   body):
        """Does a POST request to /mrd/addLg.

        TODO: type endpoint description here.

        Args:
            accept (str): TODO: type description here.
            body (MrdAddLgRequest): TODO: type description here.
    ...
    def mrd_add_lg_1(self,
                     accept):
        """Does a GET request to /mrd/addLg.
