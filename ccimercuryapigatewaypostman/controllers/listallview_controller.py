...
class ListallviewController(BaseController):

    """A Controller to access Endpoints in the ccimercuryapigatewaypostman API."""
    def __init__(self, config):
        super(ListallviewController, self).__init__(config)

    def dashboard_listallview(self,
                              accept,
                              body):
        """Does a POST request to /dashboard/listallview.

        TODO: type endpoint description here.

        Args:
            accept (str): TODO: type description here.
            body (DashboardListallviewrequest): TODO: type description here.
    ...
    def dashboard_listallview_1(self,
                                accept):
        """Does a GET request to /dashboard/listallview.
