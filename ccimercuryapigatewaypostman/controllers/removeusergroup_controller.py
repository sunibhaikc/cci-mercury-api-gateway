...
class RemoveusergroupController(BaseController):

    """A Controller to access Endpoints in the ccimercuryapigatewaypostman API."""
    def __init__(self, config):
        super(RemoveusergroupController, self).__init__(config)

    def usergroup_removeusergroup(self,
                                  accept):
        """Does a POST request to /usergroup/removeusergroup.
        ...
        return super().new_api_call_builder.request(
            ...
            .path('/usergroup/removeusergroup')
    ...
    def usergroup_removeusergroup_1(self,
                                    accept):
        """Does a GET request to /usergroup/removeusergroup.
