...
class GetLanguageController(BaseController):

    """A Controller to access Endpoints in the ccimercuryapigatewaypostman API."""
    def __init__(self, config):
        super(GetLanguageController, self).__init__(config)

    def mrd_get_language(self,
                         accept):
        """Does a POST request to /mrd/getLanguage.
    ...
    def mrd_get_language_1(self,
                           accept):
        """Does a GET request to /mrd/getLanguage.
