...
class DelTemplateController(BaseController):

    """A Controller to access Endpoints in the ccimercuryapigatewaypostman API."""
    def __init__(self, config):
        super(DelTemplateController, self).__init__(config)

    def template_filter_del_template(self,
                                     accept,
                                     body):
        """Does a POST request to /templateFilter/delTemplate.

        TODO: type endpoint description here.

        Args:
            accept (str): TODO: type description here.
            body (TemplateFilterDelTemplateRequest): TODO: type description
                here.
        ...
        return super().new_api_call_builder.request(
            ...
            .path('/templateFilter/delTemplate')
    ...
    def template_filter_del_template_1(self,
                                       accept):
        """Does a GET request to /templateFilter/delTemplate.
