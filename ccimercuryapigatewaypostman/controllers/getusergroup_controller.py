...
class GetusergroupController(BaseController):

    """A Controller to access Endpoints in the ccimercuryapigatewaypostman API."""
    def __init__(self, config):
        super(GetusergroupController, self).__init__(config)

    def group_getusergroup(self,
                           accept):
        """Does a POST request to /group/getusergroup.
    ...
    def group_getusergroup_1(self,
                             accept):
        """Does a GET request to /group/getusergroup.
