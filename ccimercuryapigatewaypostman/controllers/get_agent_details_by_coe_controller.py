...
class GetAgentDetailsByCOEController(BaseController):

    """A Controller to access Endpoints in the ccimercuryapigatewaypostman API."""
    def __init__(self, config):
        super(GetAgentDetailsByCOEController, self).__init__(config)

    def view_get_agent_details_by_coe(self,
                                      accept):
        """Does a POST request to /view/getAgentDetailsByCOE.
        ...
        return super().new_api_call_builder.request(
            ...
            .path('/view/getAgentDetailsByCOE')
    ...
    def view_get_agent_details_by_coe_1(self,
                                        accept):
        """Does a GET request to /view/getAgentDetailsByCOE.
