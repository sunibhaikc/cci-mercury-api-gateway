...
class AddTemplateController(BaseController):

    """A Controller to access Endpoints in the ccimercuryapigatewaypostman API."""
    def __init__(self, config):
        super(AddTemplateController, self).__init__(config)

    def template_filter_add_template(self,
                                     accept,
                                     body):
        """Does a POST request to /templateFilter/addTemplate.

        TODO: type endpoint description here.

        Args:
            accept (str): TODO: type description here.
            body (TemplateFilterAddTemplateRequest): TODO: type description
                here.
        ...
        return super().new_api_call_builder.request(
            ...
            .path('/templateFilter/addTemplate')
    ...
    def template_filter_add_template_1(self,
                                       accept):
        """Does a GET request to /templateFilter/addTemplate.
