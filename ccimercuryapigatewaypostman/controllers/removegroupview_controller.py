...
class RemovegroupviewController(BaseController):

    """A Controller to access Endpoints in the ccimercuryapigatewaypostman API."""
    def __init__(self, config):
        super(RemovegroupviewController, self).__init__(config)

    def groupview_removegroupview(self,
                                  accept):
        """Does a POST request to /groupview/removegroupview.
        ...
        return super().new_api_call_builder.request(
            ...
            .path('/groupview/removegroupview')
    ...
    def groupview_removegroupview_1(self,
                                    accept):
        """Does a GET request to /groupview/removegroupview.
