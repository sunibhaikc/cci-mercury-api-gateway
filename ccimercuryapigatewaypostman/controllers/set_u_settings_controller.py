...
class SetUSettingsController(BaseController):

    """A Controller to access Endpoints in the ccimercuryapigatewaypostman API."""
    def __init__(self, config):
        super(SetUSettingsController, self).__init__(config)

    def usetting_set_u_settings(self,
                                accept):
        """Does a POST request to /usetting/setUSettings.
    ...
    def usetting_set_u_settings_1(self,
                                  accept):
        """Does a GET request to /usetting/setUSettings.
