...
class SetviewfavoriteController(BaseController):

    """A Controller to access Endpoints in the ccimercuryapigatewaypostman API."""
    def __init__(self, config):
        super(SetviewfavoriteController, self).__init__(config)

    def view_setviewfavorite(self,
                             accept,
                             body):
        """Does a POST request to /view/setviewfavorite.

        TODO: type endpoint description here.

        Args:
            accept (str): TODO: type description here.
            body (ViewSetviewfavoriterequest): TODO: type description here.
    ...
    def view_setviewfavorite_1(self,
                               accept):
        """Does a GET request to /view/setviewfavorite.
