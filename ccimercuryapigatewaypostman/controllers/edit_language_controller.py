...
class EditLanguageController(BaseController):

    """A Controller to access Endpoints in the ccimercuryapigatewaypostman API."""
    def __init__(self, config):
        super(EditLanguageController, self).__init__(config)

    def mrd_edit_language(self,
                          accept,
                          body):
        """Does a POST request to /mrd/editLanguage.

        TODO: type endpoint description here.

        Args:
            accept (str): TODO: type description here.
            body (MrdEditLanguageRequest): TODO: type description here.
    ...
    def mrd_edit_language_1(self,
                            accept):
        """Does a GET request to /mrd/editLanguage.
