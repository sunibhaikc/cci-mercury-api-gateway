...
class MapgroupuserController(BaseController):

    """A Controller to access Endpoints in the ccimercuryapigatewaypostman API."""
    def __init__(self, config):
        super(MapgroupuserController, self).__init__(config)

    def usergroup_mapgroupuser(self,
                               accept):
        """Does a POST request to /usergroup/mapgroupuser.
    ...
    def usergroup_mapgroupuser_1(self,
                                 accept):
        """Does a GET request to /usergroup/mapgroupuser.
