...
class GetFMController(BaseController):

    """A Controller to access Endpoints in the ccimercuryapigatewaypostman API."""
    def __init__(self, config):
        super(GetFMController, self).__init__(config)

    def mrd_get_fm(self,
                   accept,
                   body):
        """Does a POST request to /mrd/getFM.

        TODO: type endpoint description here.

        Args:
            accept (str): TODO: type description here.
            body (MrdGetFMRequest): TODO: type description here.
    ...
    def mrd_get_fm_1(self,
                     accept):
        """Does a GET request to /mrd/getFM.
