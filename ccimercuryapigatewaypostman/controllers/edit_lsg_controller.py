...
class EditLsgController(BaseController):

    """A Controller to access Endpoints in the ccimercuryapigatewaypostman API."""
    def __init__(self, config):
        super(EditLsgController, self).__init__(config)

    def mrd_edit_lsg(self,
                     accept,
                     body):
        """Does a POST request to /mrd/editLsg.

        TODO: type endpoint description here.

        Args:
            accept (str): TODO: type description here.
            body (MrdEditLsgRequest): TODO: type description here.
    ...
    def mrd_edit_lsg_1(self,
                       accept):
        """Does a GET request to /mrd/editLsg.
