...
class ViewconfigController(BaseController):

    """A Controller to access Endpoints in the ccimercuryapigatewaypostman API."""
    def __init__(self, config):
        super(ViewconfigController, self).__init__(config)

    def view_viewconfig(self,
                        accept):
        """Does a POST request to /view/viewconfig.
    ...
    def view_viewconfig_1(self,
                          accept):
        """Does a GET request to /view/viewconfig.
