...
class EditTemplateController(BaseController):

    """A Controller to access Endpoints in the ccimercuryapigatewaypostman API."""
    def __init__(self, config):
        super(EditTemplateController, self).__init__(config)

    def template_filter_edit_template(self,
                                      accept,
                                      body):
        """Does a POST request to /templateFilter/editTemplate.

        TODO: type endpoint description here.

        Args:
            accept (str): TODO: type description here.
            body (TemplateFilterEditTemplateRequest): TODO: type description
                here.
        ...
        return super().new_api_call_builder.request(
            ...
            .path('/templateFilter/editTemplate')
    ...
    def template_filter_edit_template_1(self,
                                        accept):
        """Does a GET request to /templateFilter/editTemplate.
