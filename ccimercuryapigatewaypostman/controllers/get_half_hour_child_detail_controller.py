...
class GetHalfHourChildDetailController(BaseController):

    """A Controller to access Endpoints in the ccimercuryapigatewaypostman API."""
    def __init__(self, config):
        super(GetHalfHourChildDetailController, self).__init__(config)

    def view_get_half_hour_child_detail(self,
                                        accept):
        """Does a POST request to /view/getHalfHourChildDetail.
        ...
        return super().new_api_call_builder.request(
            ...
            .path('/view/getHalfHourChildDetail')
    ...
    def view_get_half_hour_child_detail_1(self,
                                          accept):
        """Does a GET request to /view/getHalfHourChildDetail.
