...
class GetMercuryliteController(BaseController):

    """A Controller to access Endpoints in the ccimercuryapigatewaypostman API."""
    def __init__(self, config):
        super(GetMercuryliteController, self).__init__(config)

    def mrd_get_mercurylite(self,
                            accept,
                            body):
        """Does a POST request to /mrd/getMercurylite.

        TODO: type endpoint description here.

        Args:
            accept (str): TODO: type description here.
            body (MrdGetMercuryliteRequest): TODO: type description here.
    ...
    def mrd_get_mercurylite_1(self,
                              accept):
        """Does a GET request to /mrd/getMercurylite.
