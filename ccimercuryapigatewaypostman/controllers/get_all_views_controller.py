...
class GetAllViewsController(BaseController):

    """A Controller to access Endpoints in the ccimercuryapigatewaypostman API."""
    def __init__(self, config):
        super(GetAllViewsController, self).__init__(config)

    def view_get_all_views(self,
                           accept,
                           body):
        """Does a POST request to /view/getAllViews.

        TODO: type endpoint description here.

        Args:
            accept (str): TODO: type description here.
            body (ViewGetAllViewsRequest): TODO: type description here.
    ...
    def view_get_all_views_1(self,
                             accept):
        """Does a GET request to /view/getAllViews.
