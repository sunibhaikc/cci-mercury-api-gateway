...
class AddLsgController(BaseController):

    """A Controller to access Endpoints in the ccimercuryapigatewaypostman API."""
    def __init__(self, config):
        super(AddLsgController, self).__init__(config)

    def mrd_add_lsg(self,
                    accept,
                    body):
        """Does a POST request to /mrd/addLsg.

        TODO: type endpoint description here.

        Args:
            accept (str): TODO: type description here.
            body (MrdAddLsgRequest): TODO: type description here.
    ...
    def mrd_add_lsg_1(self,
                      accept):
        """Does a GET request to /mrd/addLsg.
