...
class GetTemplateController(BaseController):

    """A Controller to access Endpoints in the ccimercuryapigatewaypostman API."""
    def __init__(self, config):
        super(GetTemplateController, self).__init__(config)

    def template_filter_get_template(self,
                                     accept,
                                     body):
        """Does a POST request to /templateFilter/getTemplate.

        TODO: type endpoint description here.

        Args:
            accept (str): TODO: type description here.
            body (TemplateFilterGetTemplateRequest): TODO: type description
                here.
        ...
        return super().new_api_call_builder.request(
            ...
            .path('/templateFilter/getTemplate')
    ...
    def template_filter_get_template_1(self,
                                       accept):
        """Does a GET request to /templateFilter/getTemplate.
