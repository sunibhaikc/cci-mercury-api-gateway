...
class GetUSettingController(BaseController):

    """A Controller to access Endpoints in the ccimercuryapigatewaypostman API."""
    def __init__(self, config):
        super(GetUSettingController, self).__init__(config)

    def usetting_get_u_setting(self,
                               accept,
                               body):
        """Does a POST request to /usetting/getUSetting.

        TODO: type endpoint description here.

        Args:
            accept (str): TODO: type description here.
            body (UsettingGetUSettingRequest): TODO: type description here.
    ...
    def usetting_get_u_setting_1(self,
                                 accept):
        """Does a GET request to /usetting/getUSetting.
