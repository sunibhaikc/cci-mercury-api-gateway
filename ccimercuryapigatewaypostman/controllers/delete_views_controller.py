...
class DeleteViewsController(BaseController):

    """A Controller to access Endpoints in the ccimercuryapigatewaypostman API."""
    def __init__(self, config):
        super(DeleteViewsController, self).__init__(config)

    def view_delete_views(self,
                          accept):
        """Does a POST request to /view/deleteViews.
    ...
    def view_delete_views_1(self,
                            accept):
        """Does a GET request to /view/deleteViews.
