...
class GetViewController(BaseController):

    """A Controller to access Endpoints in the ccimercuryapigatewaypostman API."""
    def __init__(self, config):
        super(GetViewController, self).__init__(config)

    def view_get_view(self,
                      accept):
        """Does a POST request to /view/getView.
    ...
    def view_get_view_1(self,
                        accept):
        """Does a GET request to /view/getView.
