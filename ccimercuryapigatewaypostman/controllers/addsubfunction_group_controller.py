...
class AddsubfunctionGroupController(BaseController):

    """A Controller to access Endpoints in the ccimercuryapigatewaypostman API."""
    def __init__(self, config):
        super(AddsubfunctionGroupController, self).__init__(config)

    def mrd_addsubfunction_group(self,
                                 accept,
                                 body):
        """Does a POST request to /mrd/addsubfunctionGroup.

        TODO: type endpoint description here.

        Args:
            accept (str): TODO: type description here.
            body (MrdAddsubfunctionGroupRequest): TODO: type description
                here.
    ...
    def mrd_addsubfunction_group_1(self,
                                   accept):
        """Does a GET request to /mrd/addsubfunctionGroup.
