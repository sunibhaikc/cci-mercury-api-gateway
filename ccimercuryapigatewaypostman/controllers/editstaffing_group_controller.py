...
class EditstaffingGroupController(BaseController):

    """A Controller to access Endpoints in the ccimercuryapigatewaypostman API."""
    def __init__(self, config):
        super(EditstaffingGroupController, self).__init__(config)

    def mrd_editstaffing_group(self,
                               accept,
                               body):
        """Does a POST request to /mrd/editstaffingGroup.

        TODO: type endpoint description here.

        Args:
            accept (str): TODO: type description here.
            body (MrdEditstaffingGroupRequest): TODO: type description here.
    ...
    def mrd_editstaffing_group_1(self,
                                 accept):
        """Does a GET request to /mrd/editstaffingGroup.
