...
class UpdatelastlogindateController(BaseController):

    """A Controller to access Endpoints in the ccimercuryapigatewaypostman API."""
    def __init__(self, config):
        super(UpdatelastlogindateController, self).__init__(config)

    def user_updatelastlogindate(self,
                                 accept):
        """Does a POST request to /user/updatelastlogindate.
    ...
    def user_updatelastlogindate_1(self,
                                   accept):
        """Does a GET request to /user/updatelastlogindate.
