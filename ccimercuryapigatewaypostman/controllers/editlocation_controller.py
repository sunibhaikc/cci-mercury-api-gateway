...
class EditlocationController(BaseController):

    """A Controller to access Endpoints in the ccimercuryapigatewaypostman API."""
    def __init__(self, config):
        super(EditlocationController, self).__init__(config)

    def mrd_editlocation(self,
                         accept):
        """Does a POST request to /mrd/editlocation.
    ...
    def mrd_editlocation_1(self,
                           accept):
        """Does a GET request to /mrd/editlocation.
