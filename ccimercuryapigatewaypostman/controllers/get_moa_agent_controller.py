...
class GetMoaAgentController(BaseController):

    """A Controller to access Endpoints in the ccimercuryapigatewaypostman API."""
    def __init__(self, config):
        super(GetMoaAgentController, self).__init__(config)

    def liteview_get_moa_agent(self,
                               accept):
        """Does a POST request to /liteview/getMoaAgent.
    ...
    def liteview_get_moa_agent_1(self,
                                 accept):
        """Does a GET request to /liteview/getMoaAgent.
