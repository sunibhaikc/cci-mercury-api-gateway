...
class EditLobController(BaseController):

    """A Controller to access Endpoints in the ccimercuryapigatewaypostman API."""
    def __init__(self, config):
        super(EditLobController, self).__init__(config)

    def mrd_edit_lob(self,
                     accept,
                     body):
        """Does a POST request to /mrd/editLob.

        TODO: type endpoint description here.

        Args:
            accept (str): TODO: type description here.
            body (MrdEditLobRequest): TODO: type description here.
    ...
    def mrd_edit_lob_1(self,
                       accept):
        """Does a GET request to /mrd/editLob.
