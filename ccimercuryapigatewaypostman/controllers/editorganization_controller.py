...
class EditorganizationController(BaseController):

    """A Controller to access Endpoints in the ccimercuryapigatewaypostman API."""
    def __init__(self, config):
        super(EditorganizationController, self).__init__(config)

    def mrd_editorganization(self,
                             accept,
                             body):
        """Does a POST request to /mrd/editorganization.

        TODO: type endpoint description here.

        Args:
            accept (str): TODO: type description here.
            body (MrdEditorganizationrequest): TODO: type description here.
    ...
    def mrd_editorganization_1(self,
                               accept):
        """Does a GET request to /mrd/editorganization.
