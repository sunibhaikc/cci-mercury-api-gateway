...
class EditFMController(BaseController):

    """A Controller to access Endpoints in the ccimercuryapigatewaypostman API."""
    def __init__(self, config):
        super(EditFMController, self).__init__(config)

    def mrd_edit_fm(self,
                    accept,
                    body):
        """Does a POST request to /mrd/editFM.

        TODO: type endpoint description here.

        Args:
            accept (str): TODO: type description here.
            body (MrdEditFMRequest): TODO: type description here.
    ...
    def mrd_edit_fm_1(self,
                      accept):
        """Does a GET request to /mrd/editFM.
