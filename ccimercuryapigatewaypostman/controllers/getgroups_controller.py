...
class GetgroupsController(BaseController):
    ...
    def __init__(self, config):
        super(GetgroupsController, self).__init__(config)

    def group_getgroups(self,
                        accept,
                        body):
        """Does a POST request to /group/getgroups.

        TODO: type endpoint description here.

        Args:
            accept (str): TODO: type description here.
            body (GroupGetgroupsrequest): TODO: type description here.
    ...
    def group_getgroups_1(self,
                          accept):
        """Does a GET request to /group/getgroups.
