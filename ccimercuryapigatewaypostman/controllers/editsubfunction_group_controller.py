...
class EditsubfunctionGroupController(BaseController):

    """A Controller to access Endpoints in the ccimercuryapigatewaypostman API."""
    def __init__(self, config):
        super(EditsubfunctionGroupController, self).__init__(config)

    def mrd_editsubfunction_group(self,
                                  accept,
                                  body):
        """Does a POST request to /mrd/editsubfunctionGroup.

        TODO: type endpoint description here.

        Args:
            accept (str): TODO: type description here.
            body (MrdEditsubfunctionGroupRequest): TODO: type description
                here.
    ...
    def mrd_editsubfunction_group_1(self,
                                    accept):
        """Does a GET request to /mrd/editsubfunctionGroup.
