...
class EditfunctionMappingController(BaseController):

    """A Controller to access Endpoints in the ccimercuryapigatewaypostman API."""
    def __init__(self, config):
        super(EditfunctionMappingController, self).__init__(config)

    def mrd_editfunction_mapping(self,
                                 accept):
        """Does a POST request to /mrd/editfunctionMapping.
    ...
    def mrd_editfunction_mapping_1(self,
                                   accept):
        """Does a GET request to /mrd/editfunctionMapping.
