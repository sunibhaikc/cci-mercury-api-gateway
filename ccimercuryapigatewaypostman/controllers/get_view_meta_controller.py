...
class GetViewMetaController(BaseController):

    """A Controller to access Endpoints in the ccimercuryapigatewaypostman API."""
    def __init__(self, config):
        super(GetViewMetaController, self).__init__(config)

    def liteview_get_view_meta(self,
                               accept):
        """Does a POST request to /liteview/getViewMeta.
    ...
    def liteview_get_view_meta_1(self,
                                 accept):
        """Does a GET request to /liteview/getViewMeta.
