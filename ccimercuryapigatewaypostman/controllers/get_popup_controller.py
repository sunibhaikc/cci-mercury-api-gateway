...
class GetPopupController(BaseController):

    """A Controller to access Endpoints in the ccimercuryapigatewaypostman API."""
    def __init__(self, config):
        super(GetPopupController, self).__init__(config)

    def mrd_get_popup(self,
                      accept,
                      body):
        """Does a POST request to /mrd/getPopup.

        TODO: type endpoint description here.

        Args:
            accept (str): TODO: type description here.
            body (MrdGetPopupRequest): TODO: type description here.
    ...
    def mrd_get_popup_1(self,
                        accept):
        """Does a GET request to /mrd/getPopup.
