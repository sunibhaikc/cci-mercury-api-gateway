...
class MapusergroupController(BaseController):

    """A Controller to access Endpoints in the ccimercuryapigatewaypostman API."""
    def __init__(self, config):
        super(MapusergroupController, self).__init__(config)

    def usergroup_mapusergroup(self,
                               accept):
        """Does a POST request to /usergroup/mapusergroup.
    ...
    def usergroup_mapusergroup_1(self,
                                 accept):
        """Does a GET request to /usergroup/mapusergroup.
