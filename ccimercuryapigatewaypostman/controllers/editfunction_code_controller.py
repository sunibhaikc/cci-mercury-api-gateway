...
class EditfunctionCodeController(BaseController):

    """A Controller to access Endpoints in the ccimercuryapigatewaypostman API."""
    def __init__(self, config):
        super(EditfunctionCodeController, self).__init__(config)

    def mrd_editfunction_code(self,
                              accept,
                              body):
        """Does a POST request to /mrd/editfunctionCode.

        TODO: type endpoint description here.

        Args:
            accept (str): TODO: type description here.
            body (MrdEditfunctionCodeRequest): TODO: type description here.
    ...
    def mrd_editfunction_code_1(self,
                                accept):
        """Does a GET request to /mrd/editfunctionCode.
